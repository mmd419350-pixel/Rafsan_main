...
const config = {
    // Bot Identity
    botName: process.env.BOT_NAME || 'Rafsan-bbz',
    botOwner: process.env.BOT_OWNER || ' Rafsan-bbz',
    ownerNumber: process.env.OWNER_NUMBER || '8801757312387',
    author: process.env.AUTHOR || 'Rafan-bbz',
    packname: process.env.PACKNAME || 'Rafsan-bbz',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/xafsan/Rafsan-bbz/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'xafsan',
    // Session
    sessionId: process.env.SESSION_ID || '',
    pairingNumber: process.env.PAIRING_NUMBER || '88',
    // Performance
