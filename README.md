...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Rafsan-bbz&fontSize=72&fontColor=fff&animation=twinkling&fontAlignY=32&desc=High%20Performance%20WhatsApp%20Bot&descAlignY=55&descSize=20" width="100%"/>
...
[![Version](https://img.shields.io/badge/Version-6.0.0-blue?style=for-the-badge&logo=github)](https://github.com/Xchristech2/Rafsan-bbz)
...
[![Stars](https://img.shields.io/github/stars/Xchristech2/Rafsan-bbz?style=for-the-badge&logo=starship&color=gold)](https://github.com/Xchristech2/Rafsan-bbz/stargazers)
[![Forks](https://img.shields.io/github/forks/Xchristech2/Rafsan-bbz?style=for-the-badge&logo=git&color=orange)](https://github.com/Xchristech2/Rafsan-bbz/network/members)
...
```bash
git clone https://github.com/Xchristech2/Rafsan-bbz.git
cd Rafsan-bbz
npm install
cp sample.env .env
...
```bash
sudo bash <(curl -fsSL https://raw.githubusercontent.com/Xchristech2/Rafsan-bbz/main/lib/install.sh)
```
> [!IMPORTANT]
...
```bash
# After install:
nano /root/Rafsan-bbz/.env
cd /root/Rafsan-bbz && pm2 start dist/index.js --name gaaju-md
...
3. Open **Secrets** tab (🔒) and add:
   ...
   | Key | Value |
   |---|---|
   | `SESSION_ID` | `Xchristech2/Rafsan-bbz_your_gist_id` |
...
**One-line Deployer:**
```bash
bash <(curl -s https://raw.githubusercontent.com/Xchristech2/Rafsan-bbz/main/lib/heroku.sh)
```
**Manual:**
```bash
heroku login
...
heroku config:set SESSION_ID=Xchristech2/Rafsan-bbz_your_gist_id
...
**One-line Deployer:**
```bash
bash <(curl -s https://raw.githubusercontent.com/Xchristech2/Rafsan-bbz/main/lib/fly.sh)
```
**Manual:**
```bash
...
fly secrets set SESSION_ID=Xchristech2/Rafsan-bbz_your_gist_id
...
# Run
docker run -d \
  -e SESSION_ID=Xchristech2/Rafsan-bbz_your_gist_id \
...
export default {
    ...
    async handler(sock: any, message: any, args: any[], context: any = {}) {
        const {
            ...
            channelInfo       // Rafsan-bbz branding spread
        } = context;
...
> [!IMPORTANT]
> - Verify `SESSION_ID` starts with `GlobalTechInfo/Rafsan-bbz_`
...
[![Telegram](https://img.shields.io/badge/Telegram-FF0000?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/Official_ChrisRafsan-bbzChat)
...
[![GitHub Issues](https://img.shields.io/badge/GitHub_Issues-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Xchristech2/Rafsan-bbz/issues)
...
[MIT License](LICENSE) · Made with ❤️ by **Chris Rafsan-bbz** · [Xchristech2](https://github.com/Xchristech2)
