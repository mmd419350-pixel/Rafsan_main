...
const phoneNumber = config.pairingNumber || config.ownerNumber || "8801757312387";
...
global.botname = config.botName || "Rafsan-bbz";
global.themeemoji = "•";
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    await QasimDev.sendMessage(botNumber, {
                        text: `🤖 RAFSAN-BOT CONNECTED 😩🤪!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!${ghostStatus}\n\n✅ POWER BY- RAFSAN,,😎 l`,
                        contextInfo: {
                            forwardingScore: 1,
                            is: true,
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: '120363406588763460@newsletter',
                                newsletterName: 'CHRIS Rafsan-bbz TECH',
                                serverMessageId: -1
                            }
                        }
                    });
                ...
                printLog('info', `[ ${config.botName || 'Rafsan-bbz'} ]`);
...
async function main() {
    ...
    printLog('info', 'Starting Rafsan-bbz BOT...');
